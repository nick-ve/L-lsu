...
\item[] \begin{center}
        {\red \shabox{
        $a(t_{e})=a_{0}\left[1+H_{0}(t_{e}-t_{o})-\frac{1}{2}q_{0}H_{0}^{2}(t_{e}-t_{o})^{2}+\ldots\right]$
        }}
        \end{center}
...
\item[] \begin{center}
        {\red \shabox{
        $z=H_{0}(t_{o}-t_{e})+(1+\frac{1}{2}q_{0})H_{0}^{2}(t_{o}-t_{e})^{2}+\ldots$
        }}
        \end{center}
\item In a similar way we can obtain an expression for the {\blue light travel time}
\item[] \begin{center}
        {\red \shabox{
        $(t_{o}-t_{e})={\displaystyle \frac{1}{H_{0}}}\left[z-(1+\frac{1}{2}q_{0})z^{2}+\ldots\right]$
        }}
        \end{center}
